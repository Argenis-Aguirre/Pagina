...
const db = mysql.createConnection({
  host: 'bd-plantas.clw6gke84ffk.us-east-2.rds.amazonaws.com',
  user: 'admin',
  password: 'Admin10$', // Recuerda no dejar las contraseñas en texto claro en producción
...
app.use(cors({ origin: 'https://plantas.s3.us-east-2.amazonaws.com/build/' })); // Cambia por el URL real de tu bucket
